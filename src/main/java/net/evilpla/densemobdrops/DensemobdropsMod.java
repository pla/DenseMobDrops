 ...
 *
 *    Keep the ElementsDensemobdropsMod object in this class and all calls to this object
...
public class DensemobdropsMod {
	...
	@Mod.Instance(MODID)
	public static DensemobdropsMod instance;
	public ElementsDensemobdropsMod elements = new ElementsDensemobdropsMod();
	@Mod.EventHandler
	public void preInit(FMLPreInitializationEvent event) {
		MinecraftForge.EVENT_BUS.register(this);
		GameRegistry.registerWorldGenerator(elements, 5);
		GameRegistry.registerFuelHandler(elements);
		NetworkRegistry.INSTANCE.registerGuiHandler(this, new ElementsDensemobdropsMod.GuiHandler());
